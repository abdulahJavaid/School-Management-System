...
if (isset($_POST['paid_teacher'])) {
    ...
    if (!empty($_POST['bonus1'])) {
        ...
        $bonus1 = $_POST['bonus1'];
        $query = "INSERT INTO salary_bonus(fk_salary_id, bonus_title, bonus_amount) ";
        $query .= "VALUES('$salary_id', '$bonus1t', '$bonus1')";
    ...
    if (!empty($_POST['bonus2'])) {
        ...
        $bonus2 = $_POST['bonus2'];
        $query = "INSERT INTO salary_bonus(fk_salary_id, bonus_title, bonus_amount) ";
        $query .= "VALUES('$salary_id', '$bonus2t', '$bonus2')";
    ...
    if (!empty($_POST['bonus3'])) {
        ...
        $bonus3 = $_POST['bonus3'];
        $query = "INSERT INTO salary_bonus(fk_salary_id, bonus_title, bonus_amount) ";
        $query .= "VALUES('$salary_id', '$bonus3t', '$bonus3')";
            ...
            <div class="col-xl-9">
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        $salary_id = escape($_GET['id']);
                        $query = "SELECT * FROM employee_salary WHERE salary_id='$salary_id'";
