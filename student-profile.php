          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
              ...
              <!-- Profile Edit Form -->
                ...
                <form>
                <div class="row mb-3">
                  <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Student Name</label>
                  <div class="col-md-8 col-lg-9">
                    <input name="fullName" type="text" class="form-control" id="fullName" value="">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="fullName" class="col-md-4 col-lg-3 col-form-label">CNIC/B-FORM</label>
                  <div class="col-md-8 col-lg-9">
                    <input name="fullName" type="text" class="form-control" id="fullName" value="">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="Country" class="col-md-4 col-lg-3 col-form-label">Class</label>
                  <div class="col-md-8 col-lg-9">
                ...
                <div class="row mb-3">
                  <label for="Twitter" class="col-md-4 col-lg-3 col-form-label">Issue code</label>
                  <div class="col-md-8 col-lg-9">
                ...
                <div class="row mb-3">
                  <label for="Facebook" class="col-md-4 col-lg-3 col-form-label">Password</label>
                  <div class="col-md-8 col-lg-9">
