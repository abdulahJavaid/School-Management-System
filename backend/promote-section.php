...
// for passout section
if (isset($_POST['passout_section_id'])) {
    $section_id = escape($_POST['passout_section_id']);
...
// for promote section
if (isset($_POST['promote_section_id'])) {
    $section_id = escape($_POST['promote_section_id']);
    ...
    if (mysqli_num_rows($result) != 0) {
        ...
        $matches[] = [
            'message' => 'Class is empty, no students to Promote.'
        ];
    }
...
// for promote section not empty
if (isset($_POST['empty_section_id'])) {
    $section_id = escape($_POST['empty_section_id']);
    ...
    if (mysqli_num_rows($result) != 0) {
        $matches[] = [
            'message' => 'Class is not empty, Promotion is not possible.'
        ];
    } else {
        $matches[] = [
            'messages' => 'Class is not empty, Promotion is not possible.'
        ];
    }
...
// for demote section
if (isset($_POST['demote_section_id'])) {
    $section_id = escape($_POST['demote_section_id']);
    ...
    if (mysqli_num_rows($result) != 0) {
        ...
        $matches[] = [
            'message' => 'Class is empty, no students to Demote.'
        ];
    }
...
// for demotion section empty
if (isset($_POST['d_empty_section_id'])) {
    $section_id = escape($_POST['d_empty_section_id']);
    ...
    if (mysqli_num_rows($result) != 0) {
        $matches[] = [
            'messages' => 'Class is empty, Demotion is not possible.'
        ];
    } else {
        $matches[] = [
            'message' => 'Class is empty, Demotion is not possible.'
        ];
    }
...
// for passout section
if (isset($_POST['left_section_id'])) {
    $section_id = escape($_POST['left_section_id']);
