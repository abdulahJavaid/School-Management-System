...
<!-- for demoting a class -->
<div class="modal fade" id="demote" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header card-bg-header text-white">
                <h5 class="modal-title" id="dstaticBackdropLabel"><strong></strong></h5>
                <button type="button" class="ms-auto bg-transparent border-0 text-white" data-bs-dismiss="modal" aria-label="Close"><i class="fa fa-times" aria-hidden="true"></i></button>
            </div>
            <form action="" method="post">
                <div class="modal-body" id="">
                    <div class="py-2">
                        <label for="classes" class="form-label"><strong>Select Class(for demotion) <code>*</code></strong></label>
                        <div class="col-auto">
                            <div class="input-group">
                                <select id="dEmptySection"
                                    name="demotion_section"
                                    class="form-select"
                                    onchange="ifEmpty(this.value)"
                                    aria-describedby="button-addon1"
                                    required>
                                    <option value="" disabled selected>Choose Class</option>
                                    <?php
                    ...
                    <input type="hidden" name="section_id" id="demoteSectionId">
                    <input type="hidden" name="class_section" id="demoteClassSection">
                    <input type="hidden" name="demoted_students" id="demotedStudents">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancel</button>
