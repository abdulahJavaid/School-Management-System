...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="EZyXNdZZm2Gwp2x6kk1skhjtdEg5dwAZwFrJBKZzlcR+5c6Xh6S5ZVOrg2MzF2W7cwAFgi7AhdR4siyELm/dBSSqEyQiUTIUgdF284UtqWgbCahVCX2OEdz8qLbVZiv2PFdu09zU3XMd0M2FoJIvSq3hAg77/URzCsKrz/35VV95+RIKAp3TQ6br5E1SMk+hijtcrZKv15lJZCQ3IBOlQw==" />
</div>
...
<script type="text/javascript">
    ...
    function failureFunc(error) {
        alert ("On Match Process, failure has been called");
            ...
            <hr />
            <footer>
                <p>&copy; 2024 - SecuGen Corporation</p>
            </footer>
        </div>
    </form>
<script type="text/javascript">
