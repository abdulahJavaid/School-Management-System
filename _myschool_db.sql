...
CREATE TABLE `fee_requests` (
  `fee_request_id` int(11) NOT NULL,
  `fk_student_id` int(11) NOT NULL,
  `fee_method` varchar(100) NOT NULL,
  `image` varchar(255) NOT NULL,
  `year` varchar(50) NOT NULL,
  `month` varchar(50) NOT NULL,
  `fee_request_status` varchar(50) NOT NULL DEFAULT 'pending',
  `rejection_reason` text NOT NULL DEFAULT 'empty'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `fee_requests` (`fee_request_id`, `fk_student_id`, `fee_method`, `image`, `year`, `month`, `fee_request_status`, `rejection_reason`) VALUES
(1, 1, '', '', '2024', 'August', 'rejected', 'did not pay in cash'),
(2, 16, 'cash', '', '2024', 'August', 'paid', ''),
(3, 10, '', '', '2024', 'August', 'rejected', 'reject'),
(4, 29, 'cash', '', '2024', 'August', 'paid', ''),
(5, 12, '', '', '2024', 'August', 'rejected', 'rejected'),
(6, 9, 'cash', '', '2024', 'August', 'paid', ''),
(7, 20, 'cash', '', '2024', 'August', 'paid', ''),
(8, 6, 'cash', '', '2024', 'August', 'processing', ''),
(9, 5, 'cash', '', '2024', 'August', 'processing', ''),
(10, 25, 'cash', '', '2024', 'August', 'paid', '');
...
CREATE TABLE `progress_report` (
  ...
  `fk_student_id` int(20) NOT NULL,
  `progress_remarks` varchar(500) NOT NULL,
  `date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `student_fee` (
  ...
  `fk_student_id` int(20) NOT NULL,
  `fk_fee_request_id` int(11) NOT NULL,
...
INSERT INTO `student_fee` (`fee_id`, `fk_student_id`, `fk_fee_request_id`, `year`, `month`, `fee_status`, `pending_dues`) VALUES
(5, 16, 2, '2024', 'August', 'paid', 0),
(6, 29, 4, '2024', 'August', 'paid', 0),
(7, 9, 6, '2024', 'August', 'paid', 0),
(8, 20, 7, '2024', 'August', 'dues', 1000),
(9, 25, 10, '2024', 'August', 'dues', 2000);
...
ALTER TABLE `fee_requests`
  ADD PRIMARY KEY (`fee_request_id`),
  ADD KEY `fk_student_fee_request_id` (`fk_student_id`);
...
ALTER TABLE `student_fee`
  ...
  ADD KEY `fk_fee_request_id` (`fk_fee_request_id`);
...
--
ALTER TABLE `fee_requests`
  MODIFY `fee_request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `fee_requests`
  ADD CONSTRAINT `fk_student_fee_request_id` FOREIGN KEY (`fk_student_id`) REFERENCES `student_profile` (`student_id`);
...
--
ALTER TABLE `student_fee`
  ADD CONSTRAINT `fk_fee_request_id` FOREIGN KEY (`fk_fee_request_id`) REFERENCES `fee_requests` (`fee_request_id`),
