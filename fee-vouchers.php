...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <div class="row">
            ...
            ?>
                <div class="row mb-3">
                    <div class="col-md-3 mb-3">
                        <a href="./fee-vouchers.php?download_vouchers=show" class="btn btn-sm btn-success w-100">Fee vouchers</a>
                    </div>
                </div>
            <?php
            }
            ?>
            <?php
            // download dues vouchers
            if (!isset($_GET['dues_vouchers'])) {
            ?>
                <div class="row mb-3">
                    <div class="col-md-3 mb-3">
                        <a href="./fee-vouchers.php?dues_vouchers=show" class="btn btn-sm btn-success w-100">Dues vouchers</a>
                    </div>
                </div>
            <?php
            }
            ?>
            <?php
            // download current month vouchers
            if (isset($_GET['download_vouchers'])) {
                // unset($_GET['ms']);
                // unset($_GET['m']);
            ?>
                ...
                <div class="card px-0">
                    <div class="card-header card-bg-header text-dark mb-3">
                        <h5 class="mb-0">
                            <strong>Current Month Vouchers - </strong><?php echo date('Y') . ', ' . date('F'); ?>
                            <span class="d-inline-block"
                                tabindex="0"
                                data-bs-toggle="tooltip"
                                title="Vouchers of students whose fees is issued and not paid.">
                    ...
                    <div class="row mb-3 ps-3">
                        ...
                        <form action="generate-pdf.php" method="post">
                            <div class="col-sm-4 pb-3">
                                ...
                                <div class="col-auto">
                                    <div class="input-group">
                                        <select id="inputState" name="select" aria-label="Example input" aria-describedby="button-addon3" class="form-select" required>
    ...
    <?php
            } // end if - download current month vouchers
    ?>
    <?php
    // download current month vouchers
    if (isset($_GET['dues_vouchers'])) {
    ...
    ?>
        ...
        <div class="card px-0">
            <div class="card-header card-bg-header text-dark mb-3">
                <h5 class="mb-0">
                    <strong>Dues Vouchers </strong>
                    <span class="d-inline-block"
                        tabindex="0"
                        data-bs-toggle="tooltip"
                        title="Vouchers for dues can be generated.">
                        <button type="button" class="btn btn-sm btn-outline-light"><i class="fa-solid fa-question"></i></button>
                    </span>
                </h5>
            </div>
            ...
            <div class="row mb-3 ps-3">
                        ...
                        <div class="col-auto">
                            <div class="input-group">
                                <input
                                    ...
                                    placeholder="reg#"
                                    aria-describedby="button-addon2" required />
                                <button type="submit" name="student_dues_voucher" id="button-addon3" class="btn btn-sm btn-success">
                                    Download Voucher
                                </button>
                            </div>
                        </div>
                ...
                <form action="generate-pdf.php" method="post">
                    <div class="col-sm-4 pb-4">
                        <label for="section_for_dues_date" class="form-label"><strong>Select Class</strong> <code>*</code></label>
                        <div class="col-auto">
                            <div class="input-group">
                                <select id="inputState" name="section_for_dues_voucher" aria-label="Example input" aria-describedby="button-addon3" class="form-select">
                                ...
                                <button type="submit" name="class_dues_vouchers" id="button-addon3" class="btn btn-sm btn-success">
                                    Download Vouchers
                                </button>
                            </div>
                        </div>
                ...
                <form action="generate-pdf.php" method="post">
                    <div class="col-sm-4 pb-4">
                        <label for="all_students" class="form-label"><strong>For School</strong> <code>*</code></label>
                        <div class="col-auto">
                            <div class="input-group">
                                <input
                                    name="all_students_for_dues_voucher"
                                    type="text"
                                    class="form-control"
                                    aria-label="Example input"
                                    value="All students"
                                    aria-describedby="button-addon2" readonly required />
                                <button type="submit" name="school_dues_vouchers" id="button-addon3" class="btn btn-sm btn-success">
                                    Download Vouchers
                                </button>
                            </div>
                        </div>
