...
if (isset($_POST['roll_no'])) {
  ...
  $log = "Admin <strong>$admin_name</strong> generated paid fee records of student with reg# {<strong>$get_roll</strong>} !";
  ...
  // downloaded pdf name
  $pdf_name = "paid-fee-record-of-reg-no-" . $get_roll . ".pdf";
}
// the logo code
//   <div id='logo'>
