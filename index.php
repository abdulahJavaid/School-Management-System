...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="./school-profile.php"><?php echo $_SESSION['school_name']; ?></a></li>
  ...
  <style>
    .carousel {
      ...
      /* Set background color of the carousel */
    }
  ...
  <!-- Bootstrap JS and dependencies for slider -->
        ...
        <div class="row">
          ...
          <div class="col-xxl-12 col-xl-12">
            <div class="card info-card revenue-card">
              ...
              ?>
              <a href="./teachers.php" class="card-body">
