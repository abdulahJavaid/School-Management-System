                        ...
                        <div class="card-body pt-3">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xl-12">
                                                                            <div class="alert alert-info text-dark">
                                                                                <?php echo $_SESSION['school_name']; ?> should pay <strong>Rs.<?php echo $to_pay; ?></strong> to CodsMine.
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                        ...
                                        <table class="table table-bordered border-primary table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                while ($unsub_std = mysqli_fetch_assoc($get_unsub_std)) {
                                                    ...
                                                    $query = "SELECT * FROM student_subscriptions WHERE (sub_status='requested' OR sub_status='on') ";
                                                    $query .= "AND fk_client_id='$client' AND fk_student_id='$unsub_student_id'";
                            ...
                            <div class="tab-content pt-2">
                                <div class="tab-pane fade requests" id="requests">
                                    ...
                                    <h4 class="card-title text-capitalize">Subscription Requests</h4>
                                    <!-- Primary Color Bordered Table -->
                                    <div class="table-responsive">
                                        <table class="table table-bordered border-primary table-hover">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr id="app<?php echo $req_std['student_id']; ?>">
                                                        ...
                                                        <td>
                                                            <button onclick="approveSub(<?php echo $req_std['student_id']; ?>, '<?php echo 'app' . $req_std['student_id']; ?>')" class="btn btn-sm btn-outline-success">
                                                                Approve
                                                            </button>
                                                        </td>
                                                    </tr>
...
<script>
    ...
    function approveSub(id, del) {
        ...
        xhr.send('approve_sub=' + encodeURIComponent(sendId));
    }
</script>
